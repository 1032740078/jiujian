...
class TopicController extends Controller {
    ...
    async create() {
        ...
        const res = await ctx.service.editpage.development.create(ctx.request.body);
        // 设置响应体和状态码
    ...
    async inquire() {
        ...
        const res = await ctx.service.editpage.development.inquire(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
    ...
    async update() {
        ...
        const res = await ctx.service.editpage.development.update(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
    ...
    async delete() {
        ...
        const res = await ctx.service.editpage.development.delete(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
