...
class TopicController extends Controller {
    ...
    async create() {
        ...
        const res = await ctx.service.editpage.team.create(ctx.request.body);
        // 设置响应体和状态码
    ...
    async inquire() {
        ...
        const res = await ctx.service.editpage.team.inquire(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
    ...
    async update() {
        ...
        const res = await ctx.service.editpage.team.update(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
    ...
    async delete() {
        ...
        const res = await ctx.service.editpage.team.delete(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
