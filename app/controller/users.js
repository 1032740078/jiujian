...
class TopicController extends Controller {
    ...
    async inquire() {
        ...
        const res = await ctx.service.users.inquire(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
    ...
    async update() {
        ...
        const res = await ctx.service.users.update(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
    ...
    async delete() {
        ...
        const res = await ctx.service.users.delete(ctx.request.body);
        // 设置响应体和状态码
        ctx.body = {res: res.contents, message: res.message,};
        ctx.status = res.status;
    }
